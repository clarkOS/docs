...
This document outlines the implementation status of ClarkOS features in the [example agent](https://github.com/clarkOS/clark/tree/main/example/convex).

<CardGroup cols={2}>
  <Card title="Main Repository" icon="github" href="https://github.com/clarkOS/clark">
    github.com/clarkOS/clark
  </Card>
  <Card title="Example Agent" icon="code" href="https://github.com/clarkOS/clark/tree/main/example/convex">
