...
The fastest way to get started is using the [example agent](https://github.com/clarkOS/clark/tree/main/example/convex):
...
This gives you a complete reference implementation with Convex backend, core framework code, and all dependencies configured.
