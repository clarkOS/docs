...
Clone the repository and use the [example agent](https://github.com/clarkOS/clark/tree/main/example/convex) as your starting point:

```bash
git clone https://github.com/clarkOS/clark
cp -r clark/example/convex my-clark-agent
cd my-clark-agent
npm install
...
<Tip>
  The example agent at [github.com/clarkOS/clark/tree/main/example/convex](https://github.com/clarkOS/clark/tree/main/example/convex) contains all the source code referenced in this guide.
</Tip>
