...
**Reference:** `TickContext` in [`src/core/types.ts`](https://github.com/clarkOS/clark/blob/main/example/convex/src/core/types.ts)
...
**Reference:** `sortPluginsByDependencies()` in [`src/plugins/loader.ts`](https://github.com/clarkOS/clark/blob/main/example/convex/src/plugins/loader.ts) handles topological sorting
...
**Reference:** `MemoryBackend` in [`src/backend/memory.ts`](https://github.com/clarkOS/clark/blob/main/example/convex/src/backend/memory.ts)
