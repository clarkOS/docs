...
<Steps>
  <Step title="Clone the repository">
    Clone the ClarkOS repository and navigate to the example agent:
    ...
    The [example agent](https://github.com/clarkOS/clark/tree/main/example/convex) gives you a fully-configured project with:
